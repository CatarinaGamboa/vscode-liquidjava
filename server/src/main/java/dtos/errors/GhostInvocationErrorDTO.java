 ...
 */
public record GhostInvocationErrorDTO(String category, String type, String title, String message, String details, String file, ErrorPosition position,
    ...
    public static GhostInvocationErrorDTO from(GhostInvocationError error) {
        return new GhostInvocationErrorDTO("error", "ghost-invocation-error", error.getTitle(), error.getMessage(), error.getDetails(), error.getFile(),
